...
<html lang="en">
<head>
<title>Code coverage report for yauzl/index.js</title>
<meta charset="utf-8">
...
<div class="header high">
	<h1>Code coverage report for <span class="entity">yauzl/index.js</span></h1>
	...
	<div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">yauzl/</a> &#187; index.js</div>
</div>
<div class="body">
...
function open(path, options, callback) {
  ...
  <span class="missing-if-branch" title="if path not taken">I</span>if (callback == null) <span class="cstat-no"
																								title="statement not covered">callback = defaultCallback;</span>
...
<span class="cstat-no" title="statement not covered">    options = null;</span>
  ...
  <span class="missing-if-branch" title="if path not taken">I</span>if (options == null) <span class="cstat-no"
																							   title="statement not covered">options = {autoClose: false};</span>
  <span class="missing-if-branch" title="if path not taken">I</span>if (callback == null) <span class="cstat-no"
																								title="statement not covered">callback = defaultCallback;</span>
...
ZipFile.prototype.close = function() {
  <span class="missing-if-branch" title="if path not taken">I</span>if (!this.isOpen) <span class="cstat-no"
...
function emitError(self, err) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (self.emittedError) <span class="cstat-no"
																								 title="statement not covered">return;</span>
...
function readEntries(self) {
  ...
  readFdSlicerNoEof(self.fdSlicer, buffer, 0, buffer.length, self.readEntryCursor, function(err) {
    <span class="missing-if-branch" title="if path not taken">I</span>if (err) <span class="cstat-no"
																					 title="statement not covered">return emitErrorAndAutoClose(self, err);</span>
    <span class="missing-if-branch" title="if path not taken">I</span>if (self.emittedError) <span class="cstat-no"
																								   title="statement not covered">return;</span>
    var entry = new Entry();
...
ZipFile.prototype.openReadStream = function(entry, callback) {
  var self = this;
  <span class="missing-if-branch" title="if path not taken">I</span>if (!self.isOpen) <span class="cstat-no"
																							title="statement not covered">return callback(new Error("closed"));</span>
...
<span class="cstat-no" title="statement not covered">    return setImmediate(<span class="fstat-no"
																				   title="function not covered">function() {</span> <span
		class="cstat-no" title="statement not covered">callback(null, new Buffer(0)); </span>});</span>
  }
  fdSlicer.read(buffer, offset, length, position, function(err, bytesRead) {
    <span class="missing-if-branch" title="if path not taken">I</span>if (err) <span class="cstat-no"
																					 title="statement not covered">return callback(err);</span>
    <span class="missing-if-branch" title="if path not taken">I</span>if (bytesRead &lt; length) <span class="cstat-no"
																									   title="statement not covered">return callback(new Error("unexpected EOF"));</span>
    callback();
  });
}
&nbsp;
...
function defaultCallback(err) {
  <span class="missing-if-branch" title="if path not taken">I</span>if (err) <span class="cstat-no"
																				   title="statement not covered">throw err;</span>
}
&nbsp;</pre>
</td>
</tr>
...
<div class="footer">
	<div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Dec 03 2014
		16:28:28 GMT-0700 (MST)
	</div>
</div>
