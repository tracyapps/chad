 ...
 */
?>
<h3><?php _e( 'Author Box Settings', 'chad' ); ?></h3>

<p><span class="description"><?php _e( 'Choose where you would like to display an author box.', 'chad' ); ?></span></p>
		...
		<tr>
			<td>
				<label for="flagbox[flagship_author_box_single]">
					...
					<?php _e( 'Enable Author Box on this User\'s Posts?', 'chad' ); ?>
				</label><br />
				...
				<label for="flagbox[flagship_author_box_archive]">
					...
					<?php _e( 'Enable Author Box on this User\'s Archives?', 'chad' ); ?>
				</label>
			</td>
		</tr>
	</tbody>
