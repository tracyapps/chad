...
function flagship_tiny_mce_formats( $args ) {
	$flagship_formats = apply_filters( 'flagship_tiny_mce_formats',
		array(
			array(
				'title'    => __( 'Drop Cap', 'chad' ),
				'inline'   => 'span',
				'classes'  => 'dropcap',
			),
			array(
				'title'    => __( 'Pull Quote Left', 'chad' ),
				'block'    => 'blockquote',
				'classes'  => 'pullquote alignleft',
				'wrapper'  => true,
			),
			array(
				'title'    => __( 'Pull Quote Right', 'chad' ),
				'block'    => 'blockquote',
				'classes'  => 'pullquote alignright',
				'wrapper'  => true,
			),
			array(
				'title'    => __( 'Intro Paragraph', 'chad' ),
				'selector' => 'p',
				'classes'  => 'intro-pagragraph',
				'wrapper'  => true,
			),
			array(
				'title'    => __( 'Call to Action', 'chad' ),
				'block'    => 'div',
			...
			array(
				'title'    => __( 'Code Block', 'chad' ),
				'format'   => 'pre',
			),
			array(
				'title'    => __( 'Buttons', 'chad' ),
				'items'    => array(
					array(
						'title'    => __( 'Standard', 'chad' ),
						'selector' => 'a',
						'classes'  => 'button',
						'exact'    => true,
					),
					array(
						'title'    => __( 'Standard Block', 'chad' ),
						'selector' => 'a',
					...
					array(
						'title'    => __( 'Call to Action Block', 'chad' ),
						'selector' => 'a',
