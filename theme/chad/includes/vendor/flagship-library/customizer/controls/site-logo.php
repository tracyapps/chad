...
class Flagship_Site_Logo_Image_Control extends WP_Customize_Control {
	...
	public function __construct( $wp_customize, $control_id, $args = array() ) {
		...
		$this->l10n = array(
			'upload'      => __( 'Add logo',    'chad' ),
			'set'         => __( 'Set as logo', 'chad' ),
			'choose'      => __( 'Choose logo', 'chad' ),
			'change'      => __( 'Change logo', 'chad' ),
			'remove'      => __( 'Remove logo', 'chad' ),
			'placeholder' => __( 'No logo set', 'chad' ),
		);
